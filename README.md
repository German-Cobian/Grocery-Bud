...
* Run this command in your OS terminal: `git clone git@github.com:German-Cobian/Grocery-Bud.git` to get a copy of the project
...
Feel free to check the [issues page](https://github.com/German-Cobian/Grocery-Bud/issues).
...
[MIT licensed](https://github.com/German-Cobian/Grocery-Bud/blob/main/LICENSE).